...
$MESS["ARTURGOLUBEV_CHATGPT_MAIN_ELEMENT_WRITE_FOR_SERVICE"] = "для услуги ";
$MESS["ARTURGOLUBEV_CHATGPT_MAIN_ELEMENT_WRITE_FOR_PRODUCT_SECTION"] = "для раздела каталога ";

$MESS["ARTURGOLUBEV_CHATGPT_MAIN_ELEMENT_TRANSLATE_LANG"] = "на #lang# язык ";

$MESS["ARTURGOLUBEV_CHATGPT_MAIN_ELEMENT_WRITE_LENGTH"] = ", не более #length# символов ";
$MESS["ARTURGOLUBEV_CHATGPT_MAIN_ELEMENT_WRITE_HTML"] = "сделай html разметку";
...
// mass 
$MESS["ARTURGOLUBEV_CHATGPT_MASS_SKIPPED"] = "Генерация для данного элемента пропущена.";
$MESS["ARTURGOLUBEV_CHATGPT_MASS_NO_EMPTY_SAVE_FIELD"] = "Поле для сохранения не пустое.";

// other
$MESS["ARTURGOLUBEV_CHATGPT_GENERAL_CHATGPT_ERROR"] = "Получен ответ (ошибка):";
$MESS["ARTURGOLUBEV_CHATGPT_GENERAL_ERROR"] = "Ошибка:";
$MESS["ARTURGOLUBEV_CHATGPT_GENERAL_EMPTY_FIELD_FROM_ERROR"] = "Пустое значение поля-основания";
...
$MESS["ARTURGOLUBEV_CHATGPT_GENERAL_NO_API_KEY_ERROR"] = "Не введён API ключ в настройках решения";
$MESS["ARTURGOLUBEV_CHATGPT_MAIN_WRITE_TOKEN_PRICING"] = "На запрос потрачено #tcount# токенов";
$MESS["ARTURGOLUBEV_CHATGPT_END_KEY_LIST"] = "Проверены все API ключи";

// sber
$MESS["ARTURGOLUBEV_CHATGPT_SBER_NO_ACCESS_TOKEN_ERROR"] = "Не удалось получить токен доступа";

// visual
$MESS["ARTURGOLUBEV_CHATGPT_MASS_GENERATE_BUTTON"] = "ИИ Генератор: Массовая генерация данных";
