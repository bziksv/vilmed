...
class Table
{
    ...
    protected function readHeader()
    {
		...
		$this->setEncodingByCode($this->languageCode);
	...
	protected function setEncodingByCode($code)
	{
		$arCodes = array(
			"\x65" => 'CP866',
			"\xC8" => 'CP1251',
		...
		if(isset($arCodes[$code])) $this->encoding = $arCodes[$code];
		else $this->encoding = 'CP866';
	}
	...
	{
		return mb_substr($str, $start, ($length===null ? 2000000000 : $length), $this->encoding);
	}
	...
	{
		return mb_strpos($str, $needle, $offset, $this->encoding);
	}
	...
	public static function getSiteEncoding()
	{
		...
		return ToUpper($logicalEncoding);
	}
}
