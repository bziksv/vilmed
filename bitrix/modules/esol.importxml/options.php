...
if($USER->IsAdmin())
{
	...
	<tr>
		...
		<td>
			...
			&nbsp; <a href="https://esolutions.su/marketplace/oauth.php?get_token=1" target="_blank"><? echo Loc::getMessage('ESOL_IX_OPTIONS_GOOGLE_DRIVE_APIKEY_GET'); ?></a>
		</td>
	</tr>
	...
	if(!Loader::includeModule('catalog') && Loader::includeModule('iblock'))
	{
		...
		$arRels = unserialize(COption::GetOptionString($moduleId, 'CATALOG_RELS'), ['allowed_classes'=>[]]);
