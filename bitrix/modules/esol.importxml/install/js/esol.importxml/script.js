...
var EProfile = {
	...
	ShowCron: function()
	{
		var cronWindowPath = '/bitrix/admin/'+esolIXModuleFilePrefix+'_cron_settings.php?lang='+BX.message('LANGUAGE_ID');
...
var EProfileList = {
	...
	{
		var windowUrl = '/bitrix/admin/'+esolIXModuleFilePrefix+'_profile_list.php?lang='+BX.message('LANGUAGE_ID')+'&action=shownewgroupform';
		var dialogParams = {
		...
		dialog.SetButtons([
			...
			new BX.CWindowButton(
			{
				...
				action: function () {
					...
					$.ajax({
						url: '/bitrix/admin/'+esolIXModuleFilePrefix+'_profile_list.php?lang='+BX.message('LANGUAGE_ID'),
						type: 'POST',
	...
	ShowRestoreWindow: function(suffix)
	{
		var windowUrl = '/bitrix/admin/'+esolIXModuleFilePrefix+'_restore_profiles.php?lang='+BX.message('LANGUAGE_ID')+(suffix ? '&suffix='+suffix : '');
		var dialogParams = {
			'title':BX.message("ESOL_IX_POPUP_RESTORE_PROFILES_TITLE"),
			'content_url':windowUrl,
			'width':'700',
			...
			$('input[type=file]', newForm).bind('change', function(){
				...
				$.ajax({
					...
					success: function(data, textStatus, jqXHR)
					{
						...
						$('#esol_restore_profile_list input[type="checkbox"]:not(#kda_ie_restoreprofile_all)').bind('change', function(){
