...
foreach($arProfiles as $PROFILE_ID)
{
	...
	{
		if(\Bitrix\EsolImportxml\Utils::IsUtfMode()) $DATA_FILE_NAME = $APPLICATION->ConvertCharsetArray($DATA_FILE_NAME, LANG_CHARSET, 'CP1251');
	...
	echo date('Y-m-d H:i:s').": import complete\r\n"."Profile id = ".$PROFILE_ID." - highload\r\n".\Bitrix\EsolImportxml\Utils::PhpToJSObject($arResult)."\r\n\r\n";
}
?>