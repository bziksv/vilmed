...
if(!is_array($_POST['EMAIL_SETTINGS']))
{
	...
	$_POST['EMAIL_SETTINGS'] = \Bitrix\EsolImportxml\Utils::JsObjectToPhp($es);
	if(!is_array($_POST['EMAIL_SETTINGS'])) $_POST['EMAIL_SETTINGS'] = \Bitrix\EsolImportxml\Utils::Unserialize($es);
...
elseif(is_array($_POST['EMAIL_SETTINGS']) && !\Bitrix\EsolImportxml\Utils::IsUtfMode()) 
{
