...
if($bUserIsAdmin || $bHasWRight)
{
	...
	if(CModule::IncludeModule('highloadblock'))
	{
		$aSubMenu[] = array(
			...
			"more_url" => array(
				$moduleFilePrefix."_profile_list_highload.php"
			),
	...
	$aSubMenu[] = array(
		"text" => GetMessage("ESOL_MENU_IMPORT_TITLE_STAT_WRAP"),
		"title" => GetMessage("ESOL_MENU_IMPORT_TITLE_STAT_WRAP"),
		"module_id" => $moduleId,
		"items_id" => "menu_".$moduleIdUl,
		"sort" => 300,
		"section" => $moduleIdUl,
		'items' => array(
			...
			array(
				"text" => GetMessage("ESOL_MENU_IMPORT_TITLE_STAT_DETAIL"),
				"url" => $moduleFilePrefix."_event_log.php?lang=".LANGUAGE_ID,
				"title" => GetMessage("ESOL_MENU_IMPORT_TITLE_STAT_DETAIL"),
				"module_id" => $moduleId,
				"items_id" => "menu_".$moduleIdUl,
				"sort" => 200,
				"section" => $moduleIdUl,
