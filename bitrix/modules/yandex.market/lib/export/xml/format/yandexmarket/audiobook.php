	...
	public function getOffer()
	{
		return new Xml\Tag\Offer([
			...
			'attributes' => [
				...
				new Xml\Attribute\Base(['name' => 'bid', 'value_type' => Type\Manager::TYPE_NUMBER]),
			],
			'children' => array_merge(
				...
				[
					...
					new Xml\Tag\Base(['name' => 'year', 'value_type' => Type\Manager::TYPE_NUMBER]),
					new Xml\Tag\Base(['name' => 'volume', 'value_type' => Type\Manager::TYPE_NUMBER]),
					new Xml\Tag\Base(['name' => 'part', 'value_type' => Type\Manager::TYPE_NUMBER]),
					...
					new Xml\Tag\Base(['name' => 'recording_length', 'value_type' => Type\Manager::TYPE_RECORDING_LENGTH]),
				],
