		...
		switch ($place)
		{
			case 'prolog':
				$result = array_filter([
					...
					new Xml\Tag\Base(['name' => 'video', 'value_type' => 'file', 'multiple' => true, 'max_count' => 6]),
				...
				array_push(
					$result,
					new Xml\Tag\Name(['visible' => true]),
					new Xml\Tag\Vendor(['visible' => true, 'preselect' => true]),
					new Xml\Tag\Model(),
					new Xml\Tag\VendorCode(['visible' => true, 'preselect' => true]),
			...
			case 'epilog':
				$result = [
					...
					new Xml\Tag\MarketCategoryId(['visible' => true, 'preselect' => true]),
					new Xml\Tag\SetIds(),
