		...
		return [
			...
			new Main\Entity\EnumField('ENTITY_TYPE', [
				...
				'values' => [
					...
					static::ENTITY_TYPE_CATALOG_PRODUCT,
				],
			]),
			...
			new Main\Entity\ReferenceField('CATALOG_PRODUCT', Market\Catalog\Product\Table::class, [
				'=this.ENTITY_TYPE' => [ '?', static::ENTITY_TYPE_CATALOG_PRODUCT ],
				'=this.ENTITY_ID' => 'ref.ID',
			]),
		];
	}
