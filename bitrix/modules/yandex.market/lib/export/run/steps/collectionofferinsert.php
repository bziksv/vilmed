...
class CollectionOfferInsert extends Base
{
	...
	public function fetch(Data\Run\Waterfall $waterfall, $action, Data\Run\Offset $offset)
	{
		do
		{
			$limit = 100;
	...
	public function write(Data\Run\Waterfall $waterfall, array $elementIds)
	{
	...
	public function commit(Data\Run\Waterfall $waterfall, array $elementIds)
	{
