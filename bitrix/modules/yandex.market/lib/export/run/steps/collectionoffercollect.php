...
class CollectionOfferCollect extends Base
{
	...
	public function iterateCollection(Data\Run\Waterfall $waterfall, CollectionOffer\CollectState $state, Data\Run\Offset $offset)
	{
		...
		foreach ($this->processor->getSetup()->getCollectionCollection() as $collection)
		{
			...
			$waterfall->next($nextState, $offset);
	...
	public function iterateFeedCollection(Data\Run\Waterfall $waterfall, CollectionOffer\CollectState $state, Data\Run\Offset $offset)
	{
	...
	public function iterateProduct(Data\Run\Waterfall $waterfall, CollectionOffer\CollectState $state, Data\Run\Offset $offset)
	{
	...
	/** @noinspection DuplicatedCode */
	public function loadElements(Data\Run\Waterfall $waterfall, CollectionOffer\CollectState $state, Data\Run\Offset $offset)
	{
		do
		{
			...
			$waterfall->next($queryResult['ELEMENT'], $priorities, $state);
	...
	public function writeStorage(Data\Run\Waterfall $waterfall, array $elements, array $priorities, CollectionOffer\CollectState $state)
	{
