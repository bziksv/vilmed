...
class Category extends Base
{
	...
	{
		return Market\Export\Run\Storage\CategoryTable::class;
	}
			...
			if (!empty($usedSectionIds))
			{
				...
				switch ($fieldType)
				{
					...
					case Market\Export\Entity\Data::TYPE_SERVICE_CATEGORY:
						$typeSectionList = $this->getSectionListFromService($usedSectionIds);
					break;
	 ...
	 */
	protected function getSectionListFromService($usedSectionIds)
	{
		$result = [];
