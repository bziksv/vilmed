...
abstract class OrderRegistry
{
	 ...
	 * @return string|null
	 */
	public function searchBrokenList($externalIds, $campaignId, Platform $platform, $useAccountNumber = null)
	{
	 ...
	 * @return string|null
	 */
	public function searchBroken($externalId, $campaignId, Platform $platform, $useAccountNumber = null)
	{
