		...
		TradingService\Reference\Action\HasActivity
{
	...
	{
        /** @var TradingService\MarketplaceDbs\Api\SendCancellationAccept\Request $result */
		$result = $this->provider->getRequestFactory()->create(TradingService\MarketplaceDbs\Api\SendCancellationAccept\Request::class);
