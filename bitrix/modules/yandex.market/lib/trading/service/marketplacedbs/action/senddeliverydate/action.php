	...
	implements TradingService\Reference\Action\HasActivity
{
	...
	{
        /** @var TradingService\MarketplaceDbs\Api\SendDeliveryDate\Request $result */
		$result = $this->provider->getRequestFactory()->create(TradingService\MarketplaceDbs\Api\SendDeliveryDate\Request::class);
