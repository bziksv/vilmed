	...
	implements TradingService\Reference\Action\HasActivity
{
	...
	{
        /** @var TradingService\MarketplaceDbs\Api\SendDeliveryStorageLimit\Request $result */
		$result = $this->provider->getRequestFactory()->create(TradingService\MarketplaceDbs\Api\SendDeliveryStorageLimit\Request::class);
