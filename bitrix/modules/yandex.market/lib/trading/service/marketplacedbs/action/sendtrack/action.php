...
class Action extends TradingService\Reference\Action\DataAction
{
	...
	{
        /** @var TradingService\MarketplaceDbs\Options $options */
	...
	{
		$result = $this->provider->getRequestFactory()->create(TradingService\MarketplaceDbs\Api\SendTrack\Request::class);
