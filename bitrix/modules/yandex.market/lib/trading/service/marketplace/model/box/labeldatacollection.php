...
class LabelDataCollection extends Market\Api\Reference\Collection
{
	...
	public static function fetch(TradingService\Common\Options $options, $orderId)
	{
		$request = new TradingService\Marketplace\Api\BoxLabels\Request($options->getCampaignId(), $options->getApiAuth());
