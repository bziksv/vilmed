...
class Action extends TradingService\Reference\Action\DataAction
{
	...
	{
		$request = $this->provider->getRequestFactory()->create(TradingService\Marketplace\Api\Shipments\Request::class);
		$request->processParameters($this->request->getParameters());
