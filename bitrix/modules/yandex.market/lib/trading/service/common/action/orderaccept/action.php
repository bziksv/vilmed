...
class Action extends TradingService\Common\Action\Cart\Action
{
	...
	protected function searchBrokenOrder()
	{
		...
		return $orderRegistry->searchBroken($orderId, $campaignId, $platform, false);
	}
	...
	protected function fillXmlId()
	{
		...
		$this->order->fillXmlId($externalId, $campaignId, $platform);
	}
	...
	protected function modifyBasket()
	{
		...
		foreach ($items as $itemIndex => $item)
		{
			...
			else
			{
                ...
                $basketData = $this->extendBasketData($item, $basketData);
