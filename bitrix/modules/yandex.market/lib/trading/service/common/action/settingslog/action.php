...
class Action extends TradingService\Common\Action\HttpAction
{
	...
	{
		$result = [
			'=SETUP_TYPE' => Market\Glossary::SERVICE_TRADING,
		...
		$result += array_filter([
			...
			'=AUDIT' => $this->sanitizeEnum('audit', $this->request->getAudit(), array_merge(...array_values(Market\Logger\Trading\Audit::getVariants()))),
