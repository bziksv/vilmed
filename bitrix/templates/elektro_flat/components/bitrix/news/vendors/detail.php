...
$arSelect = array("ID", "IBLOCK_ID", "NAME", "PREVIEW_PICTURE", "DETAIL_PICTURE", "DETAIL_TEXT", "PREVIEW_TEXT");
...
if($obCache->InitCache($arParams["CACHE_TIME"], $cache_id, $cache_dir)) {
	...
	if($arElement = $rsElement->GetNext()) {
		...
		if($arElement["PREVIEW_PICTURE"] > 0)
			...
			$arCurVendor["DETAIL_PICTURE"] = CFile::GetFileArray($arElement["DETAIL_PICTURE"]);
		$arCurVendor["PREVIEW_TEXT"] = $arElement["PREVIEW_TEXT"];
		$arCurVendor["DETAIL_TEXT"] = $arElement["DETAIL_TEXT"];
