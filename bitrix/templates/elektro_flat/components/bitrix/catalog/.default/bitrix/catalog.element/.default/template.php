					...
					<div class="article_rating">
						...
						<div class="catalog-detail-article" id="<?=$arItemIDs['ARTICLE']?>">
							...
							//DETAIL_ARTICLE//
								...
								<div class="article">
									<?=GetMessage("CATALOG_ELEMENT_ARTNUMBER")?><?=!empty($arResult["PROPERTIES"]["ARTNUMBER"]["VALUE"]) ? $arResult["PROPERTIES"]["ARTNUMBER"]["VALUE"] : $arResult["PROPERTIES"]["CML2_ARTICLE"]["VALUE"] ;?>
								</div>
							<?}?>
						</div>
						<?//DETAIL_RATING//?>
