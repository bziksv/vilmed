	...
	public static function ensureSchema(): void
	{
		...
		$DB->Query("
			CREATE TABLE IF NOT EXISTS titlo_relevance_queue (
				...
				TLP_MISSING_LIMIT int(11) NOT NULL DEFAULT 300,
		...
		$alters = [
			...
			'TLP_MISSING_LIMIT' => 'ALTER TABLE titlo_relevance_queue ADD COLUMN TLP_MISSING_LIMIT int(11) NOT NULL DEFAULT 300 AFTER EXISTING_POLICY',
