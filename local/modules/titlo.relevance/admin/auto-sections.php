	...
	<details class="titlo-howto">
		...
		<div class="titlo-howto__body">
			<ul>
				...
				<li>
					<strong>Описание</strong> — текст раздела категории в Bitrix (поле DESCRIPTION).
					Колонка «Описание» — есть ли оно и сколько символов.
				</li>
				<li>
				...
				<li>
					<strong>Верхняя таблица</strong> — категории. <strong>Внизу</strong> — журнал заданий только по категориям.
					«Текст не писали» = анализ был, описание не меняли.
					Колонка «Автопроработка» — автомат уже закрыл раздел, а не «есть ли текст».
				</li>
				<li>
					Сценарий: ветка «Ветеринария» → фильтр «Уже есть балл» → отметили слабые → «Полная проработка» → «Переписать» → в очередь.
				</li>
				<li>
					<strong>Прогнать уже отмеченную категорию снова</strong>: поиск по ID → галка →
