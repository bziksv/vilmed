...
<div class="titlo-names titlo-auto-products titlo-auto-sections">
	...
	<div class="filters">
		<?php AdminUi::renderSectionBranchFilter($sectionId, 'категории'); ?>
		<label>Фильтр
		...
		<input type="text" id="titlo-auto-q" class="adm-input" placeholder="ID / название / код категории" value="<?= htmlspecialcharsbx($q) ?>" style="width:280px">
