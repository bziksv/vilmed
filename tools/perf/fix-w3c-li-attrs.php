...
$sql = "SELECT ID, IBLOCK_ID, CODE, DETAIL_TEXT, PREVIEW_TEXT FROM b_iblock_element
	WHERE DETAIL_TEXT LIKE '%<li>%<p>%'
	   ...
	   OR DETAIL_TEXT LIKE '%<tr>%</tr>%'
	   OR DETAIL_TEXT LIKE '% 6=\"%'
	   OR DETAIL_TEXT LIKE '%margin-%'
	   OR DETAIL_TEXT LIKE '%mso-%'
	   OR DETAIL_TEXT LIKE '%<br>%</li>%'
	   OR DETAIL_TEXT LIKE '%</li>%<br%'
	   OR DETAIL_TEXT LIKE '%<ul>%<h2%'
	   OR DETAIL_TEXT LIKE '%<ol>%<h2%'
	   OR DETAIL_TEXT LIKE '%<ol>%<br%'
	   OR DETAIL_TEXT LIKE '%<ol>%<p%'
	   OR DETAIL_TEXT LIKE '%<ol>%<ol%'
	   OR DETAIL_TEXT LIKE '%<ul>%<ul%'
	   OR DETAIL_TEXT LIKE '%<span>%<p%'
	   OR DETAIL_TEXT LIKE '%<h2>%<h2%'
	   OR DETAIL_TEXT LIKE '%align=\"%'
	   OR DETAIL_TEXT LIKE '%</p>%</p>%'
